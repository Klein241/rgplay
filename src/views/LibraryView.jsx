    ...
    <div className="space-y-6 pb-56 sm:pb-64 animate-fadeIn select-none">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-1">
        <div>
          ...
          <p className="text-2xs text-[#a78bfa]">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-xl bg-linear-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-slate-950 text-xs font-black shadow-md flex items-center gap-1.5 transition-all cursor-pointer"
          >
        ...
        {SUB_TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={`whitespace-nowrap px-4 py-2 rounded-2xl text-xs sm:text-sm tracking-wider uppercase font-heading font-extrabold transition-all cursor-pointer shrink-0 flex items-center gap-1.5 border ${
                isActive
                  ? 'bg-linear-to-r from-purple-600 via-fuchsia-600 to-pink-600 text-white border-purple-400/80 shadow-lg shadow-purple-600/40 scale-105'
              ...
              return (
                ...
                >
                  ...
                  <div className="relative w-full aspect-2/3 rounded-xl overflow-hidden border border-white/10 shadow-lg group-hover:shadow-purple-900/50 group-hover:border-purple-400/40 transition-all duration-300 group-hover:scale-[1.03]">
                    ...
                    {isStarted && (
                      <div className="absolute bottom-0 left-0 right-0 h-1 bg-black/40">
                        <div
                          className="h-full bg-linear-to-r from-purple-500 to-amber-400"
                  ...
                  <div className="px-0.5">
                    <h4 className="text-2xs sm:text-xs font-bold text-white line-clamp-2 leading-tight group-hover:text-purple-200 transition-colors">
                      {book.title}
                    </h4>
      ...
      {activeSubTab === 'offline' && (
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="p-4 rounded-3xl bg-linear-to-r from-cyan-950/80 via-blue-950/80 to-purple-950/80 border border-cyan-500/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-xl">
          ...
          {offlineBooks.length === 0 ? (
            <div className="p-10 rounded-3xl bg-purple-950/30 border border-purple-500/20 text-center space-y-3">
              ...
              <button
                ...
                className="mt-3 px-5 py-2.5 rounded-2xl bg-linear-to-r from-purple-600 to-pink-600 text-white font-bold text-xs shadow-lg cursor-pointer"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {offlineBooks.map((book) => (
                <div
                  ...
                  className="p-4 rounded-3xl bg-linear-to-br from-[#121c2d]/90 to-[#0e1322]/95 border border-cyan-500/30 hover:border-cyan-400/60 shadow-xl transition-all flex flex-col justify-between"
                >
                  <div className="flex gap-4">
                    ...
                    <div className="min-w-0 flex-1 flex flex-col justify-between py-0.5">
                      <div>
                        ...
                        <p className="text-2xs text-[#a78bfa] truncate mt-0.5">
              ...
              {displayFavorites.map((book) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-2 w-full py-1.5 rounded-lg bg-purple-600/40 text-white text-2xs font-bold"
                  >
                    Lire 📖
                  </button>
                </div>
              ...
              <div
                ...
                className={`p-4 rounded-3xl border transition-all cursor-pointer ${
                  selectedAuthor?.name === auth.name
                    ? 'bg-linear-to-br from-purple-950/70 to-pink-950/50 border-purple-400 shadow-xl shadow-purple-950/50 scale-[1.02]'
                    : 'bg-linear-to-br from-[#1c0d38]/60 to-[#120724]/80 border-purple-500/20 hover:border-purple-400/40'
                }`}
              >
                    ...
                    <div className="space-y-2">
                      {auth.books.map(b => (
                        ...
                        >
                          ...
                          <span className="text-purple-400 font-bold text-2xs shrink-0">Lire 📖</span>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {purchasedDisplay.map((book) => (
                <div
                  ...
                  onClick={() => setSelectedEbook(book)}
                  className="p-3.5 rounded-2xl bg-linear-to-br from-[#1e0e38]/90 to-[#120724]/90 border border-emerald-500/30 hover:border-emerald-400/60 transition-all flex items-center gap-3.5 cursor-pointer group shadow-lg"
                >
                  <img
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-2xs text-[#a78bfa] truncate">
                      {book.author}
                    </p>

                ...
                >
                  ...
                  <div className="pt-3.5 mt-3 border-t border-cyan-500/20 flex items-center justify-between gap-2">
                    ...
                    <button
                      ...
                      className="py-2 px-3 rounded-xl bg-purple-600/30 hover:bg-purple-600/50 text-purple-200 border border-purple-500/30 text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                    >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 rounded-lg bg-white/10 hover:bg-white/20 text-purple-200 text-[11px] font-bold flex items-center gap-1 cursor-pointer"
                      >
